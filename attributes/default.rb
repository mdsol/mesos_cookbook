...
# If stric is true, any and all recovery errors are considered fatal. If strict
# is false, any expected errors (e.g. slave cannot recover information about
# an executor, because the slave died right before the executor registered)
# during recovery are ignored and as much state as possible is recovered.
